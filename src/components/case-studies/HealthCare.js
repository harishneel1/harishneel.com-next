    ...
    const timeline = [
        {
            ...
            items: [
                "Deployed ambient listening AI system in 3 pilot examination rooms",
                "Immediate reduction of 2 hours in daily note-taking time",
                "Automatic generation of properly formatted clinical documentation"
            ]
        },
        {
            title: "Week 1",
            ...
            items: [
                "Analyzed 24,000 patient encounters across 15 physicians",
                "Implemented real-time medical documentation AI",
                "Physicians stopped taking work home"
            ]
        }
    ];

    const outcomes = [
        { value: "4.5 → 1.2", label: "Hours spent on daily documentation" },
        { value: "+62%", label: "Increase in patient face-time" },
        { value: "89%", label: "Physician satisfaction score" },
        { value: "67%", label: "Increase in coding team efficiency" }
    ];
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                            How We Helped Northwest Medical Group Free Up 3 Hours Per Doctor Per Day
                        </h1>
                        <p className="text-xl text-gray-600 mb-12">
                            A complete transformation of clinical documentation workflow, resulting in happier physicians and
                            better patient care
                        </p>
                        <div className="grid md:grid-cols-2 gap-6">
                            <StatCard value="423%" label="ROI Achieved" />
                            <StatCard value="72%" label="Time Saved on Documentation" />
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div className="max-w-4xl mx-auto">
                        <div className="bg-gradient-to-br from-indigo-50 to-indigo-100/50 rounded-xl p-8 mb-12">
                            ...
                            <p className="text-gray-600 text-lg leading-relaxed">
                                Northwest Medical Group's clinicians were spending 62% of their time typing medical notes and
                                handling documentation, leading to physician burnout and reduced patient interaction. Through
                                our AI implementation, we transformed their workflow and gave doctors back their time to focus
                        ...
                        <div className="mt-20">
                            ...
                            <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
                                ...
                                <p className="text-gray-600 text-lg mb-6">
                                    "I became a doctor to help people, not to be a typist. This AI system handles all my documentation
                                    while I focus entirely on my patients. I'm practicing medicine again instead of data entry.
                                    For the first time in years, I'm home for dinner with my family."
                                </p>
                                <div>
                                    <div className="font-semibold text-gray-900">Dr. Sarah Martinez</div>
                                    <div className="text-gray-500">Internal Medicine</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="mt-20 text-center">
                            <div className="bg-gradient-to-br from-indigo-50 to-indigo-100/50 rounded-xl p-8">
                                ...
                                <p className="text-gray-600 text-lg mb-8">
                                    Get a free AI implementation assessment and see how much time we can save your clinicians.
                                </p>
                                <a
                                    href="#book-call"
